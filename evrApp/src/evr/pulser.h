...
public:
   ...
   */
  /*@{*/
  virtual epicsUInt8 gateMask() const = 0;
  virtual void setGateMask(epicsUInt8 mask) = 0;

  virtual epicsUInt8 gateEnable() const = 0;
  virtual void setGateEnable(epicsUInt8 mask) = 0;
  /*@}*/
};
