...
\subsection{Versioning}\label{sec:semver}
Mrfioc2 is versioned with the semantic versioning~\cite{semver} scheme,
specified on \verb!<major>.<minor>.<patch>!. In the step-by-step instructions
in this chapter you would most likely want to use the latest tagged version available,
which can be retrieved here: \url{https://git.psi.ch/epics_driver_modules/mrfioc2/tags}.
...
\item 
	...
	\verb!git checkout <latest_version>!~(see \ref{sec:semver})
...
\begin{verbatim}
msi -I evrMrmnpp/Db/ -I mrmShared/Db/
