...
\newcommand{\latestDriverVersion}{3.0.3}
...
\end{verbatim}	
	...
	\item 
		...
		\begin{verbatim}
			...
			cd ..
		\end{verbatim}
	\item \label{quickstart:copySubs} Copy the content of the substitution file  at \texttt{https://git.psi.ch/} \texttt{epics\_driver\_modules/mrfioc2/raw/\latestDriverVersion/PSI/example} 
	\texttt{/evr\_VME-300.subs} to newly created \texttt{cfg/EVR0.subs}. This substitution file can always be used as a starting point for new applications. Substitution files for other form factors are available at the same location (mrfioc2 repository in folder \texttt{PSI/example}).
	...
	\item
		...
		\end{verbatim}
	\item 
		Copy the content of the startup script at \texttt{https://git.psi.ch/epics\_driver} \texttt{\_modules/mrfioc2/raw/\latestDriverVersion/PSI/example}
		\texttt{/evr\_VME\_startup.script} to newly created \texttt{MTEST-VME-TIMINGTEST\_startup.script}. Startup scripts for other form factors are available at the same location (mrfioc2 repository in folder \texttt{PSI/example}).
