...
This tutorial demonstrates how to configure an EVR using helper template to generate pulses:
\begin{itemize}
\item 40~ns wide, 40~ns delay, triggered on event 4 in normal mode (when only the Reset-Evt is present).
