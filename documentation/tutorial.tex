...
\end{verbatim}	
	...
	\item 
		...
		\end{verbatim}
	\item 
		Copy the content of the startup script at \texttt{https://github.psi.ch/projects/} \texttt{ED/repos/mrfioc2/browse/PSI/example/VME\_startup.script?at=\latestDriverVersion} to newly created \texttt{startup.script}. Startup scripts for other form factors are available at the same location (mrfioc2 repository in folder \texttt{PSI/example}).
...
\begin{verbatim}
	...
	# SYS 	is used as a prefix for all records. In this example 
	       it is set at the beginning using 'epicsEnvSet'
	# DEVICE        "EVR0"		
	# EVR_SLOT		     3			
