...
dbpf("TST{EVRRF-Out:FP4}Freq_High-SP", "312")   ## (ns)
dbpf("TST{EVRRF-Out:FP4}Freq_Low-SP", "313")    ## (ns)
dbpf("TST{EVRRF-Out:FP4}Freq_Lvl-SP","0")     ## Force level on COIC arrival
dbpf("TST{EVRRF-Out:FP4}Ena-Sel","1")
dbpf("TST{EVRRF-Out:FP4}Pwr-Sel","On")
#dbpf("TST{EVRRF-Out:FP4}Freq_Init-SP","0")

## SROC (328 RF buckets, 656ns period)
dbpf("TST{EVRRF-Out:FP5}Mode-Sel","Frequency")
dbpf("TST{EVRRF-Out:FP5}Freq_High-SP", "820")   ## (ns)
dbpf("TST{EVRRF-Out:FP5}Freq_Low-SP", "820")    ## (ns)
dbpf("TST{EVRRF-Out:FP5}Freq_Lvl-SP","0")     ## Force level on COIC arrival
dbpf("TST{EVRRF-Out:FP5}Ena-Sel","1")
dbpf("TST{EVRRF-Out:FP5}Pwr-Sel","On")
#dbpf("TST{EVRRF-Out:FP5}Freq_Init-SP","0")
