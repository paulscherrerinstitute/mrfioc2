...
//void mrmFlash::readConfiguration() {
//    readVolatileConfiguration();
//    readNonVolatileConfiguration();
//    readEnhancedVolatileConfiguration();
//}

//void mrmFlash::readVolatileConfiguration(){
//    try{
//        printf("Volatile configuration register: 0x");
...
//        slaveSelect(true);
//        write(CMD_READ_VOLATILE_CONFIGURATION);
...
//void mrmFlash::readNonVolatileConfiguration(){
//    try{
//        printf("Non-volatile configuration register: 0x");
...
//        // Send read configuration command
//        slaveSelect(true);
//        write(CMD_READ_NONVOLATILE_CONFIGURATION);
...
//void mrmFlash::readEnhancedVolatileConfiguration(){
//    try{
//        printf("Enhanced volatile configuration register: 0x");
...
//        // Send read configuration command
//        slaveSelect(true);
//        write(CMD_READ_ENHANCED_VOLATILE_CONFIGURATION);
