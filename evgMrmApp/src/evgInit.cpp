...
REGINFO("DataBuffer_seg(0)",DataBuffer_seg(0), 8),
REGINFO("DataBuffer_seg(1)",DataBuffer_seg(1), 8),
REGINFO("DataBuffer_seg(2)",DataBuffer_seg(2), 8),
REGINFO("DataBuffer_seg(3)",DataBuffer_seg(3), 8),
REGINFO("DataBuffer_seg(4)",DataBuffer_seg(4), 8),
REGINFO("DataBuffer_seg(5)",DataBuffer_seg(5), 8),
