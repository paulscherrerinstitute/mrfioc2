...
public:
    ...
    virtual epicsUInt32 gateMask() const;
    virtual void setGateMask(epicsUInt32 mask);

    virtual epicsUInt32 gateEnable() const;
    virtual void setGateEnable(epicsUInt32 mask);
