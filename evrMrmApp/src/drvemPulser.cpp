...
void
MRMPulser::setGateMask(epicsUInt8 mask){
...
MRMPulser::gateEnable() const{
    ...
    return (epicsUInt8)gate;
}

void
MRMPulser::setGateEnable(epicsUInt8 gate){
    epicsUInt32 pulserCtrl;
